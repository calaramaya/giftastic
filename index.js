...
var soccerArray = ["Firmino", "Salah", "Sadio Mane", "Klopp", "Gerrard", "Jordan Henderson", "van Dijk", "Emre Can"];
...
function searchGif(soName) {
    $.ajax({
            url: 'https://api.giphy.com/v1/gifs/search?q= ' + soName + ' &api_key=Y9mcJcO4QQYTiIvhxONJBsQ3GCXN9GA0',
            method: 'GET',
        })
